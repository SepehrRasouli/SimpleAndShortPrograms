...
parser.add_argument("-c", help="Comment for task")
parser.add_argument("-rl",help="Lists reminders")
parser.add_argument("-tl",help="Lists tasks")
parser.add_argument("-dr",help="Deletes reminder")
parser.add_argument("-dt",help="Deletes task")
